...
const Nav = () => {
  ...
  return (
      ...
      bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen'>
        ...
        gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8 bg-white/10 backdrop-blure-sm text-3xl
          ...
          {navData.map((link, index) =>{
            ...
            key={index}>
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
                ...
                <div className='border-solid border-l-white border-l-white border-l-8
